      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="prose prose-lg text-gray-700">
          ...
          <p>
            ...
            Terms of Use for access or usage of domain name https://harveys.margros.in/ (&apos;Website&apos;), including the
            related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
          </p>
          <p>
            The Platform is owned by MARGROMS PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with
            its registered office at BSMIT College, BICEP, Lab Block, 2nd Floor, Yelahanka, Bangalore North,
            Bangalore- 560064, Karnataka ,Bangalore ,India (hereinafter referred to as ‘Platform Owner’, &apos;we&apos;, &apos;us&apos;,
            &apos;our&apos;).
          </p>
          <p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              of such third party websites. These links are provided for your convenience for provide further
              information.
            </li>
            <li>
            ...
            <li>
              ...
              including reasonable attorney&apos;s fees, made by any third party or penalty imposed due to or arising out of
              Your breach of this Terms of Use, privacy Policy and other Policies, or Your violation of any law, rules
              or regulations or the rights (including infringement of intellectual property rights) of a third party.
            </li>
            <li>
              Notwithstanding anything contained in these Terms of Use, the parties shall not be liable for any failure
            ...
            <li>
              ...
              information provided on this website with all this included
            </li>
          </ul>
        </div>
      </div>
